...
class Login(object):
    def __init__(self):
        ...
        self.label_account = tkinter.Label(self.root, text='学号: ')
    ...
    def siginUp_interface(self):
        # self.root.destroy()
        tkinter.messagebox.showinfo(title='学生成绩管理系统', message='进入注册界面')
    ...
    def backstage_interface(self):
        ...
        if verifyResult == 'master':
            self.root.destroy()
            tkinter.messagebox.showinfo(title='学生成绩管理系统', message='进入管理界面')
        elif verifyResult == 'user':
            self.root.destroy()
            tkinter.messagebox.showinfo(title='学生成绩管理系统', message='进入用户界面')
        elif verifyResult == 'noAccount':
            tkinter.messagebox.showinfo(title='学生成绩管理系统', message='该账号不存在请重新输入!')
        elif verifyResult == 'noPassword':
            tkinter.messagebox.showinfo(title='学生成绩管理系统', message='账号/密码错误请重新输入!')
